 ...
 * @author Yangzhen
 **/
public class ConcurrentTask extends AbstractConcurrentControl {
    ...
    public ConcurrentTask(SinglePushManager singlePushManager, HttpPushService httpPushService) {
        super(1500);
    ...
    protected void code() {
        PushModel data = data();
        httpPushService.singlePushJson(data.getPushData(), data.getAppId(), 1);
    }
